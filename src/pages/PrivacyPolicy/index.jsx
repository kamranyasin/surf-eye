  ...
  return (
    <>
      ...
      <div className="toc-container">
        <div className="toc-heading">PRIVACY POLICY</div>
        <div className="toc-content">
          ...
          <p className="toc-bold">Interpretation and Definitions</p>
          <p className="toc-bold">Interpretation</p>
          <p>
          ...
          <p>
            ...
            this Agreement) refers to Surf Eye.
          </p>
          <p>
          ...
          <p>Website refers to Surf Eye, accessible from www.surfeye.co</p>
          <p>
            You means the individual accessing or using the Service, or the
            company, or other legal entity on behalf of which such individual is
            accessing or using the Service, as applicable.
          </p>
          <p className="toc-bold">Collecting and Using Your Personal Data</p>
          <p className="toc-bold">Types of Data Collected</p>
          <p className="toc-bold">Personal Data</p>
          <p>
          ...
          <p className="toc-bold">Tracking Technologies and Cookies</p>
          <p>
          ...
          <p className="toc-bold">Use of Your Personal Data</p>
          ...
          <p className="toc-bold">Retention of Your Personal Data</p>
          <p>
          ...
          <p className="toc-bold">Disclosure of Your Personal Data</p>
          <p className="toc-bold">Business Transactions</p>
          <p>
          ...
          <p className="toc-bold">Law enforcement</p>
          <p>
          ...
          <p className="toc-bold">Other legal requirements</p>
          <p>
          ...
          <p className="toc-bold">Children's Privacy</p>
          <p>
          ...
          <p className="toc-bold">Links to Other Websites</p>
          <p>
          ...
          <p className="toc-bold">Changes to this Privacy Policy</p>
          <p>
          ...
          <p className="toc-bold">Contact Us</p>
          <p>
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <p>By email: yoursurfeye@gmail.com</p>
        </div>
      </div>
      <Footer />
    </>
